            ...
            <div className="col-12">
                ...
                <ol className="pl-3">
                    <li>
                        ...
                        <p>Welcome to <b>Would Bee</b>.</p>
                            
                        <p><strong>Apptivism Private Limited</strong> ("Company", "we", "our", "us") operates <Link to="/">https://wouldbee.com/</Link>, companion mobile applications on Android and iOS platforms, and service on Telegram messenger (together or individually "Services", "Service", or "Matrimony Service").</p>

                        <p>Our Privacy Policy governs your use of our <strong>Service</strong>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
                    ...
                    <li>
                        <h5 className="mb-3"><b>Definitions</b></h5>
                        <p><strong>SERVICE</strong> means the website <Link to="/">https://wouldbee.com/</Link> AND/OR companion mobile applications on Android and iOS platforms, AND/OR service on Telegram messenger operated by Apptivism Private Limited.</p>
                    ...
                    <li>
                        <h5 className="pb-3"><b>Types of Data Collected</b></h5>
                        ...
                        <p className="pt-3 mb-1"><b>Other Data</b></p>
                        <p>While using our Service, we may also collect the following information: sex, age, date of birth, place of birth, passport details, citizenship, registration at place of residence and actual address, telephone number (work, mobile), details of documents on education, qualification, professional training, employment agreements, <a target="_blank" rel="noopener noreferrer" href="https://policymaker.io/non-disclosure-agreement/">NDA agreements</a> , information on bonuses and compensation, information on marital status, family members, social security (or other taxpayer identification) number, office location and other data.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <h5><b> Your Data Protection Rights Under General Data Protection Regulation (GDPR)</b></h5>
                        <p>If you are a resident of the European Union (EU) and European Economic Area (EEA), you have certain data protection rights, covered by GDPR.</p>
                        <p>We aim to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.</p>
                        <p>If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <a href="mailto:support@wouldbee.com">support@wouldbee.com</a> </p>
                    ...
                    <li>
                        <h5><b>Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</b></h5>
                        ...
                        <ol>
                            ...
                            <li>users are able to change their personal information by emailing us at <a href="mailto:support@wouldbee.com">support@wouldbee.com</a>.</li>
                        </ol>
                    ...
                    <li>
                        <h5><b>Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</b></h5>
                        <p>If you are a California resident, you are entitled to learn what data we collect about you, ask to delete your data and not to sell (share) it. To exercise your data protection rights, you can make certain requests and ask us:</p>
                        <ol>
                            <li><b>What personal information we have about you. If you make this request, we will return to you:</b>
                                <ol>
                        ...
                        <p className="pt-3">If you submit a request to stop selling your personal information, we will stop making such transfers.</p>
                        <p>Please note, if you ask us to delete or stop selling your data, it may impact your experience with us, and you may not be able to participate in certain programs or membership services which require the usage of your personal information to function. But in no circumstances, we will discriminate against you for exercising your rights.</p>
                        <p>To exercise your California data protection rights described above, please send your request(s) by email: <a href="mailto:support@wouldbee.com">support@wouldbee.com</a> </p>
                    ...
                    <li>
                        <h5><b>CI/CD tools</b></h5>
                        <p>We may use third-party Service Providers to automate the development process of our Service.</p>
                    </li>
                    <li>
                        <h5><b>Behavioral Remarketing</b></h5>
                    ...
                    <li>
                        ...
                        <p>Our Services are not intended for use by children under the age of 18 (<b>"Child"</b> or by"Children")</p>
