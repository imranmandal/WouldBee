  ...
  return (
    <div>
        ...
        <div className="faq">
            ...
            <div>
                <FAQd 
                  title="What is wouldbee?"
                  para1="Wouldbee is a matrimony app that is truly free. Other popular apps such as Shaadi.com, Jeevansathi etc allows a user to register for free but asks for money to connect with your potential matches. Not Us !"
                />
                <FAQd 
                  title="How can I register on Wouldbee?"
                ...
                <FAQd 
                  ...
                  para1="Wouldbee has tried to be as comprehensive as possible while creating the many lists being used in the Registration form. However, it is possible that your particular religion / caste, mother tongue, education, profession etc may not be represented here."
